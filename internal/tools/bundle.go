...
#root>div>*:not(:has([data-artboard])):not([data-artboard]){display:none!important}#root div:has([data-artboard])>*:not([data-artboard]):not(:has([data-artboard])){display:none!important}
</style>`
