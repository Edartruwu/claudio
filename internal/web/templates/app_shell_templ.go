...
func AppShell(projectPath string, sessionTitle string, modelBadge string, sessions []SessionInfo, children templ.Component) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/app_shell.templ`, Line: 40, Col: 45}
		}
		...
		if modelBadge != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/templates/app_shell.templ`, Line: 42, Col: 42}
			}
