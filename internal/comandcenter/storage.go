...
func (s *Storage) GetTask(id, sessionID string) (Task, error) {
	var t Task
	var blocksJSON, blockedByJSON, metadataJSON sql.NullString
	err := s.readDB.QueryRow(`
	...
	parseTaskJSON(&t, blocksJSON, blockedByJSON, metadataJSON)
	return t, nil
}
...
// parseTaskJSON decodes JSON columns into Task slice/map fields.
func parseTaskJSON(t *Task, blocksJSON, blockedByJSON, metadataJSON sql.NullString) {
