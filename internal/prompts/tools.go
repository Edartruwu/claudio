...
3. Run the following commands in parallel:
   ...
   - Create PR using gh pr create with a HEREDOC for the body

Important:
- DO NOT use the Agent tools
...
// ReadDescription returns the description for the Read tool.
...
- This tool allows Claudio to read images (eg PNG, JPG, etc). When reading an image file the contents are presented visually as Claudio is a multimodal LLM.
...
// EditDescription returns the description for the Edit tool.
...
// GrepDescription returns the description for the Grep tool.
...
// AgentDescription returns the description for the Agent tool.
func AgentDescription(agentTypes string) string {
...
**Never delegate understanding.** Don't write "based on your findings, fix the bug" or "based on the research, implement it." Those phrases push synthesis onto the agent instead of doing it yourself. Write prompts that prove you understood: include file paths, line numbers, what specifically to change.`, agentTypes)
}
...
- Use this tool for accessing information beyond Claudio's knowledge cutoff
...
func WebFetchDescription() string {
	return `- Fetches content from a specified URL and converts HTML to readable text
- Takes a URL and an optional prompt as input
- Fetches the URL content, converts HTML to markdown
- Returns the cleaned content for analysis
...
// LSPDescription returns the description for the LSP tool.
func LSPDescription() string {
...
// NotebookEditDescription returns the description for the NotebookEdit tool.
...
// TaskCreateDescription returns the description for the TaskCreate tool.
func TaskCreateDescription() string {
...
// TaskUpdateDescription returns the description for the TaskUpdate tool.
func TaskUpdateDescription() string {
...
// TaskListDescription returns the description for the TaskList tool.
func TaskListDescription() string {
...
// TaskGetDescription returns the description for the TaskGet tool.
func TaskGetDescription() string {
	return `Gets full details of a specific task by ID including description, context, and dependencies. Use TaskList for a summary view of all tasks.`
}

// EnterPlanModeDescription returns the description for the EnterPlanMode tool.
func EnterPlanModeDescription() string {
...
func ExitPlanModeDescription() string {
...
func EnterWorktreeDescription() string {
...
- Creates a new git worktree inside ` + "`.claudio/worktrees/`" + ` with a new branch based on HEAD
...
// ExitWorktreeDescription returns the description for the ExitWorktree tool.
func ExitWorktreeDescription() string {
